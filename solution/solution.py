...
OPENAI_MINI_MODEL = os.getenv("LAB_MINI_MODEL", "gemini-3.5-flash-lite")
...
def compare_models(prompt: str) -> dict:
    ...
    gemini_response, gemini_latency = call_openai(prompt)
    mini_response, mini_latency = call_openai_mini(prompt)

    cost = (len(gemini_response.split()) / 0.75) / 1000 * PRICING_PER_1K_TOKENS["gpt-4o"]["output"]
    return {
        "gpt4o_response": gemini_response,
        "mini_response": mini_response,
        "gpt4o_latency": gemini_latency,
